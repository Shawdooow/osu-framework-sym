...
namespace Symcol.Worlds.Tiles
{
    ...
    public class DrawableTilesDrawNode : DrawNode
    {
        ...
        public override void Draw(Action<TexturedVertex2D> vertexAction)
        {
            ...
            {
                Tiles[i, j].GetTexture(Clock.CurrentTime)?.DrawQuad(new Quad(TilePositions[i, j], TilePositions[i + 1, j], TilePositions[i, j + 1], TilePositions[i + 1, j + 1]), DrawInfo.Colour, vertexAction: vertexAction);
            }
